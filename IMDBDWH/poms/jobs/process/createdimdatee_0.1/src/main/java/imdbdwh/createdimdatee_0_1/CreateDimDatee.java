...
package imdbdwh.createdimdatee_0_1;
 ...
 * @status
 */
public class CreateDimDatee implements TalendJob {
	...
	private final String jobName = "CreateDimDatee";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					CreateDimDatee.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CreateDimDatee.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_IMDBDWH_CreateDimDatee = new byte[0];
		static byte[] commonByteArray_IMDBDWH_CreateDimDatee = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDBDWH_CreateDimDatee.length) {
					if (length < 1024 && commonByteArray_IMDBDWH_CreateDimDatee.length == 0) {
						commonByteArray_IMDBDWH_CreateDimDatee = new byte[1024];
					} else {
						commonByteArray_IMDBDWH_CreateDimDatee = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDBDWH_CreateDimDatee, 0, length);
				strReturn = new String(commonByteArray_IMDBDWH_CreateDimDatee, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDBDWH_CreateDimDatee, 0, length);
				strReturn = new String(commonByteArray_IMDBDWH_CreateDimDatee, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDBDWH_CreateDimDatee) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "date_dim";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:69mvhFYonX3d85UC3agAgFZWlm0bZdFfnUMPIQ==");
				...
				java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("IMDBdwhDataBase", null, null,
						new String[] { "TABLE" });
				boolean whetherExist_tDBOutput_1 = false;
				while (rsTable_tDBOutput_1.next()) {
					String table_tDBOutput_1 = rsTable_tDBOutput_1.getString("TABLE_NAME");
					if (table_tDBOutput_1.equalsIgnoreCase("date_dim")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`date_id` INT(0)  ,`full_date` DATETIME ,`year` INT(0)   not null ,`month` INT(0)   not null ,`day_of_week` VARCHAR(20)   not null ,`quarter` INT(0)   not null ,primary key(`date_id`))");
					}
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "date_dim"
						+ "` (`date_id`,`full_date`,`year`,`month`,`day_of_week`,`quarter`) VALUES (?,?,?,?,?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:mP+jjygi7n1hTQwaiiR+a8bDK4LeMw3FdrujAQ==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (util_tJoin_1.isJoined(row1)) {
							row3.release_date = util_tJoin_1.lookupValue.release_date;
						}
...
// # Output table : 'dim_director'
									dim_director_tmp.date_id = Numeric.sequence("date_id_id", 1, 1);
									dim_director_tmp.full_date = row3.release_date == null
											? TalendDate.parseDate("yyyy-MM-dd", "0000-00-00")
											: row3.release_date;
									dim_director_tmp.year = (Integer
											.parseInt(TalendDate.formatDate("yyyy", row3.release_date)));
									dim_director_tmp.month = (Integer
											.parseInt(TalendDate.formatDate("MM", row3.release_date)));
									dim_director_tmp.day_of_week = TalendDate.formatDate("EEEE", row3.release_date);
									dim_director_tmp.quarter = (Integer
											.parseInt(TalendDate.formatDate("MM", row3.release_date)) - 1) / 3 + 1;
...
// Start of branch "dim_director"
								if (dim_director != null) {
									...
									row4 = null;
									finder_tUniqRow_1.full_date = dim_director.full_date;
									finder_tUniqRow_1.hashCodeDirty = true;
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										KeyStruct_tUniqRow_1 new_tUniqRow_1 = new KeyStruct_tUniqRow_1();

										new_tUniqRow_1.full_date = dim_director.full_date;
										...
										row4.date_id = dim_director.date_id;
										row4.full_date = dim_director.full_date;
										row4.year = dim_director.year;
										row4.month = dim_director.month;
										row4.day_of_week = dim_director.day_of_week;
										row4.quarter = dim_director.quarter;
...
// Start of branch "row4"
									if (row4 != null) {
										...
										if (row4.date_id == null) {
											...
											pstmt_tDBOutput_1.setInt(1, row4.date_id);
										}

										if (row4.full_date != null) {
											date_tDBOutput_1 = row4.full_date.getTime();
										...
										pstmt_tDBOutput_1.setInt(3, row4.year);

										pstmt_tDBOutput_1.setInt(4, row4.month);

										if (row4.day_of_week == null) {
											pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(5, row4.day_of_week);
										}

										pstmt_tDBOutput_1.setInt(6, row4.quarter);
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final CreateDimDatee CreateDimDateeClass = new CreateDimDatee();

		int exitCode = CreateDimDateeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CreateDimDatee.class.getClassLoader()
					.getResourceAsStream("imdbdwh/createdimdatee_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CreateDimDatee.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : CreateDimDatee");
		}
...
/************************************************************************************************
 * 162199 characters generated by Talend Open Studio for Data Integration on the
 * 1 décembre 2024, 10:44:00 WAT
 ************************************************************************************************/