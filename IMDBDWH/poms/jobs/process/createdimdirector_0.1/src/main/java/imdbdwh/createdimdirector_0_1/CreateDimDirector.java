...
package imdbdwh.createdimdirector_0_1;
...
/**
 * Job: CreateDimDirector Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class CreateDimDirector implements TalendJob {
	...
	private final String jobName = "CreateDimDirector";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					CreateDimDirector.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CreateDimDirector.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_IMDBDWH_CreateDimDirector = new byte[0];
		static byte[] commonByteArray_IMDBDWH_CreateDimDirector = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.director_id == null) ? 0 : this.director_id.hashCode());
		...
		public boolean equals(Object obj) {
			...
			} else if (!this.director_id.equals(other.director_id))
		...
		public void copyDataTo(row4Struct other) {
			...
			other.director_id = this.director_id;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDBDWH_CreateDimDirector.length) {
					if (length < 1024 && commonByteArray_IMDBDWH_CreateDimDirector.length == 0) {
						commonByteArray_IMDBDWH_CreateDimDirector = new byte[1024];
					} else {
						commonByteArray_IMDBDWH_CreateDimDirector = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDBDWH_CreateDimDirector, 0, length);
				strReturn = new String(commonByteArray_IMDBDWH_CreateDimDirector, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDBDWH_CreateDimDirector, 0, length);
				strReturn = new String(commonByteArray_IMDBDWH_CreateDimDirector, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDBDWH_CreateDimDirector) {

				try {

					int length = 0;

					this.director_id = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.director_id, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("director_id=" + String.valueOf(director_id));
		...
		public int compareTo(row4Struct other) {
			...
			returnValue = checkNullsAndCompare(this.director_id, other.director_id);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "director_dim";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:oV9HckB0rmOioAw5w+VnlEyJ6A8x9P2Op8JB3A==");
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`director_id` INT(0)  ,`director_name` VARCHAR(100)  ,primary key(`director_id`))");
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "director_dim"
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result
									+ ((this.director_name == null) ? 0 : this.director_name.hashCode());
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:kKW9Tfdkz/QH0oXJQwYspW6To2tO6pTJTsO0gQ==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (util_tJoin_1.isJoined(row1)) {
							row3.directors = util_tJoin_1.lookupValue.directors;
						}
...
// # Output table : 'dim_director'
								dim_director_tmp.director_id = Numeric.sequence("director_id", 1, 1);
								dim_director_tmp.director_name = row3.directors.contains(",")
										? row3.directors.substring(0, row3.directors.indexOf(","))
										: row3.directors;
...
// Start of branch "dim_director"
							if (dim_director != null) {
								...
								row4 = null;
								if (dim_director.director_name == null) {
									finder_tUniqRow_1.director_name = null;
								} else {
									finder_tUniqRow_1.director_name = dim_director.director_name.toLowerCase();
								}
								...
								if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
									...
									if (dim_director.director_name == null) {
										new_tUniqRow_1.director_name = null;
									} else {
										new_tUniqRow_1.director_name = dim_director.director_name.toLowerCase();
									}
									...
									row4.director_id = dim_director.director_id;
									row4.director_name = dim_director.director_name;
...
// Start of branch "row4"
								if (row4 != null) {
									...
									if (row4.director_id == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
									} else {
										pstmt_tDBOutput_1.setInt(1, row4.director_id);
									}

									if (row4.director_name == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, row4.director_name);
									}
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final CreateDimDirector CreateDimDirectorClass = new CreateDimDirector();

		int exitCode = CreateDimDirectorClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CreateDimDirector.class.getClassLoader()
					.getResourceAsStream("imdbdwh/createdimdirector_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CreateDimDirector.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : CreateDimDirector");
		}
...
/************************************************************************************************
 * 155681 characters generated by Talend Open Studio for Data Integration on the
 * 1 décembre 2024, 00:00:59 WAT
 ************************************************************************************************/